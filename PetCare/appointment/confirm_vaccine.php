...
<body>
    <?php
        ...
        $sql = "SELECT vaccine_name FROM vaccine WHERE vaccine_id='$vaccineId'";
        $result = $conn->query($sql);
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            ...
            VALUES ('$pet_id', '$app_type', '$date', '$time', '$create_date', '$status', NULL, '$vaccineId', '$vaccinePrice', NULL, NULL, '$payment_status');";
            $result = $conn->query($sql);
            ...
            <div class="row">
                <div class="col- col-xl-9">
                    ...
                    <fieldset class="mt-4 reset" style="padding: 20px;">
                        ...
                        <div class="mt-3 row">
                            <p> Type : Vaccination </p>
                        </div>
                        <div class="row">
                            <div class="col-2 col-xl-1">
                                <label for="vaccine-name" class="mt-2 mb-2"> Vaccine </label>
                            </div>
                            <div class="col-10 col-xl-5">
                                <input type="text" id="vaccine-name" name="vaccine-name" class="form-control" readonly value="<?php echo $vaccineName; ?>">
                            </div>
                            <div class="col-2 col-xl-1">
                                <label for="price" class="mt-2 mb-2"> Price </label>
                            </div>
                            <div class="col-10 col-xl-5">
                                <input type="text" id="price" name="price" class="form-control" readonly value="<?php echo $vaccinePrice; ?>">
                            </div>
                        </div>
                    </fieldset>
