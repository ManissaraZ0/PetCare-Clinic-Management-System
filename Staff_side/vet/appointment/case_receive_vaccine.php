...
<body>
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $status = "finished";
            $update_by = $_POST["ownerId"];
            date_default_timezone_set("Asia/Bangkok");
            $update_date = date("Y-m-d");

            if (isset($_POST["vaccinated"])) {
                $sql = "UPDATE `appointment` SET `status`= '$status',
                `update_by`= '$staffId', `update_date`= '$update_date' WHERE `appointment_id`= $appId";
    ...
    <div class="mt-4 container">
        <div class="mb-3 card rounded-4">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-lg-2 col-md-4 col-sm-4 col-4 info">
        ...
        <div class="mb-3 card rounded-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="row mb-2">
                            <div class="col-xl-1 col-lg-2 col-sm-4 col-4 info">
                                <label for="pname"> Name : </label>
                            </div>
                            <div class="col-xl-5 col-lg-10 col-sm-8 col-8">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            <label for="vaccinated"><h4 class="mt-3 mb-3"><b> Vaccination status </b></h4></label>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="vaccinated" name="vaccinated" value="vaccinated" checked>
                <label class="form-check-label"> Vaccinated </label>
            </div>
            <button type="submit" class="mt-4 mb-4 btn btn-success"> Submit </button>
