...
<body>
    ...
    <script>
        function callAppointment(status, petId) {
                ...
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    for (let x in myObj) {
                        ...
                        if (appointment_type_name == 'Vaccination') {
                            ...
                            xhr2.open("GET", "../../../PetCare/profile/vaccine_name.php?appId=" + appointment_id, false);
                            xhr2.send();
                        } else {
                            detail = "";
                        }
            ...
            xhr.open("GET", "../../../PetCare/profile/appointment_table.php?status=" + status + "&petId=" + petId, true);
            xhr.send();
        }
    ...
    <div class="mt-4 container">
        <div class="mb-3 card rounded-4">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-lg-2 col-sm-4 col-4 info">
                ...
                <div class="mt-3 row justify-content-end">
                    <div class="col- col-sm-4 col-xl-1">
                        <a class="text-in-button" href="edit_owner.php?ownerId=<?php echo $ownerId; ?>">
